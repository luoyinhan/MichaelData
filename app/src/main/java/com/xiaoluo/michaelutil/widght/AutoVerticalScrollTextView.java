...
public class AutoVerticalScrollTextView extends ViewSwitcher implements ViewSwitcher.ViewFactory {
    ...
    private List<String> mOilsTitle = new ArrayList<String>();//油价title
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            next();
            number++;
            if (mOilsTitle.size() > 0) {
                setText(mOilsTitle.get(number % mOilsTitle.size()));
            }
        }
    };
    ...
    public void setData(List<String> mOilsTitle) {
        this.mOilsTitle = mOilsTitle;
        if (mOilsTitle.size() > 0) {
            setText(mOilsTitle.get(number % mOilsTitle.size()));
        }
    }
...
//        View view = LayoutInflater.from(mContext).inflate(R.layout.home_layout_oil_price, null);
    ...
    public void setText(CharSequence text) {
        ...
        t.setText(text);
//        TextView oilTitle = (TextView) t.findViewById(R.id.txt_oil_price_title);
//        TextView price = (TextView) t.findViewById(R.id.oil_price_tv);
//        oilTitle.setText(text);
//        price.setText(st_price + getResources().getString(R.string.home_oil_unit));
        showNext();
    }
