...
public class WeekView extends View {
    ...
    @Override
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {//计算自身大小
        ...
        if (heightMode == MeasureSpec.AT_MOST) {
            heightSize = (int) (mDisplayMetrics.density * 30);//高度是密度的30倍
        }
...
//        canvas.drawColor(Color.parseColor("#222222"));
        ...
        for (int i = 0; i < weekString.length; i++) {//动态 绘制星期数
